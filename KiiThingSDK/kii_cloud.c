                                               ...
                                               kii_char_t** out_etag)
{
    ...
    ret = parse_create_new_object_with_id_response(respCode, respHdr, out_etag,
	    &err);
                                  ...
                                  kii_char_t** out_etag)
{
    ...
    ret = parse_patch_object_response(respCode, respHdr, out_etag, &err);
                                    ...
                                    kii_char_t** out_etag)
{
    ...
    ret = parse_replace_object_response(respCode, respHdr, out_etag, &err);
